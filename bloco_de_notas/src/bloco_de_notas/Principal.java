...
public class Principal extends JFrame {
	...
	public void abrir(String nome) throws HeadlessException, IOException {
		...
		while (in.readLine() != null) {
			/*
			 * le linha a linha até o final que e apontado com o retorno null da função
			 * readLine que pode fazer com que o arquivo nao seja lido ate o final
			 */
	...
	public static void main(String[] args) {
		...
		nomeaq = JOptionPane.showInputDialog(null, "Entre com o nome do arquivo");
		salvar(nomeaq);
	}
